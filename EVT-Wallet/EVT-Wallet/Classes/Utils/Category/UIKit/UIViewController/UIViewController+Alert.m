...
+ (void)showAlertViewWithTitle:(NSString *)title message:(NSString *)message confirmTitle:(NSString *)confirmTitle confirmAction:(void(^)(void))confirmAction {
    ...
    [self showAlertViewWithTitle:title message:message confirmTitle:confirmTitle preferredStyle:UIAlertControllerStyleAlert cancelTitle:nil confirmAction:confirmAction cancelAction:NULL];
}
...
+ (void)showAlertViewWithTitle:(NSString *)title message:(NSString *)message confirmTitle:(NSString *)confirmTitle cancelTitle:(NSString *)cancelTitle confirmAction:(void(^)(void))confirmAction cancelAction:(void(^)(void))cancelAction {
    [self showAlertViewWithTitle:title message:message confirmTitle:confirmTitle preferredStyle:UIAlertControllerStyleAlert cancelTitle:cancelTitle confirmAction:confirmAction cancelAction:cancelAction];
}

+ (void)showAlertViewWithTitle:(NSString *)title message:(NSString *)message confirmTitle:(NSString *)confirmTitle preferredStyle:(UIAlertControllerStyle)preferredStyle cancelTitle:(NSString *)cancelTitle confirmAction:(void(^)(void))confirmAction cancelAction:(void(^)(void))cancelAction {
    //
    UIViewController *vc = [UIViewController currentViewController];
    if ([vc isKindOfClass:[UIAlertController class]]) {
        [vc dismissViewControllerAnimated:NO completion:^{
            [self showAlertViewWithTitle:title message:message confirmTitle:confirmTitle preferredStyle:preferredStyle cancelTitle:cancelTitle confirmAction:confirmAction cancelAction:cancelAction];
            return;
        }];
    }
