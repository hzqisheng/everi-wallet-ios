...
@implementation QSCreateNFTSIssueView
...
- (void)didClickEditButton {
    self.onlyButton.selected = NO;
    self.manualButton.selected = YES;
    if (self.createNFTSIssueViewClickEditButtonBlock) {
        self.createNFTSIssueViewClickEditButtonBlock();
    }
}
