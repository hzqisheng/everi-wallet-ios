//
//  QSIssuePermissionsTransferView.m
//  EVT-Wallet
//
...
@implementation QSIssuePermissionsTransferView
...
- (void)didClickEditButton {
    self.onlyButton.selected = NO;
    self.manualButton.selected = YES;
    if (self.issuePermissionsTransferViewClickEditBlock) {
        self.issuePermissionsTransferViewClickEditBlock();
    }
}
