...
- (UIView *)noDataView {
    if (!_noDataView) {
        ...
        UILabel *noDataLabel = [UILabel labelWithName:QSLocalizedString(@"qs_home_no_ft_titlte") font:[UIFont qs_fontOfSize15] textColor:[UIColor qs_colorGray686868] textAlignment:NSTextAlignmentCenter];
