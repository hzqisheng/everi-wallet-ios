...
@interface MYTreeTableViewController : QSBaseTableViewController
...
@property (nonatomic, assign) BOOL isShowSearchBar;           // 是否显示搜索框，默认 NO
@property (nonatomic, assign) BOOL isSearchRealTime;          // 是否实时查询，默认 NO
...
/** 处理接口返回的数据，转成一个MYTreeItem的数组 供manager使用 */
